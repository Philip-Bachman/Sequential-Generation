...
def test_seq_cond_gen_x(step_type='add', x_objs=['circle'], y_objs=[0], \
                               res_tag="AAA"):
    ##############################
    ...
    var_mlp_in = MLP([Rectifier(), Identity()], \
                     [(y_dim + read_dim + read_dim + att_spec_dim), mlp_dim, 4*rnn_dim], \
                     name="var_mlp_in", **inits)
    gen_mlp_in = MLP([Rectifier(), Identity()], \
                     [        (read_dim + read_dim + att_spec_dim), mlp_dim, 4*rnn_dim], \
...
def test_seq_cond_gen_s(step_type='add', x_objs=['circle'], y_objs=[0], \
                               res_tag="AAA"):
    ##############################
    # File tag, for output stuff #
    ##############################
    ...
    con_mlp_in = MLP([Rectifier(), Identity()], \
                     [(z_slf_dim + all_spec_dim + all_read_dim), mlp_dim, 4*rnn_dim], \
                     name="con_mlp_in", **inits)
    rav_mlp_in = MLP([Rectifier(), Identity()], \
                     [(y_dim + z_slf_dim + all_spec_dim + all_read_dim), mlp_dim, 4*rnn_dim], \
...
if __name__=="__main__":
    # Test SeqCondGenX
    #test_seq_cond_gen_x(step_type='add', x_objs=['cross', 'circle', 'circle'], y_objs=[0], res_tag="T1")
    #test_seq_cond_gen_x(step_type='add', x_objs=['cross', 'circle'], y_objs=[0,1], res_tag="T2")
    #test_seq_cond_gen_x(step_type='add', x_objs=['t-up', 't-down', 'circle'], y_objs=[0,1], res_tag="T3")
    # Test SeqCondGenS
    #test_seq_cond_gen_s(step_type='add', x_objs=['cross', 'circle', 'circle'], y_objs=[0], res_tag="T1")
    #test_seq_cond_gen_s(step_type='add', x_objs=['cross', 'circle'], y_objs=[0,1], res_tag="T2")
    test_seq_cond_gen_s(step_type='add', x_objs=['t-up', 't-down', 'circle'], y_objs=[0,1], res_tag="T3")
