...
class SRRModel(object):
    ...
    def __init__(self, rng=None,
        ...
        if self.shared_param_dicts is None:
            ...
            self.s0 = theano.shared(value=s0_init, name='srr_s0')
            self.obs_logvar = theano.shared(value=zero_ary, name='srr_obs_logvar')
        ...
        #################################################################
        # Setup the iterative revelation and refinement loop using scan #
        #################################################################
