...
if __name__=="__main__":
    #########################################################################
    # Train "binarized MNIST" generative models (closed loopish LSTM triad) #
    #########################################################################
    ...
    #######################################################
    test_imocld_generation_ft(step_type='add', attention=False)
    #test_imocld_generation_ft(step_type='jump', attention=False)